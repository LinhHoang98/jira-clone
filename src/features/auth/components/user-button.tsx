...
import {useCurrent} from "@/features/auth/api/use_current";
...
export const UserButton = () => {
    ...
    if (isLoading) {
        <div
            className="size-10 rounded-full flex items-center justify-center bg-neutral-200 border border-b-neutral-300">
